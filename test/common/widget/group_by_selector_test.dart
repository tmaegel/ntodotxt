...
class MaterialAppGroupBySelector extends StatelessWidget {
  final DatabaseController dbController =
      const DatabaseController(inMemoryDatabasePath);
  final Widget selector;

  const MaterialAppGroupBySelector({
...
void main() {
  ...
  group('default tags', () {
    testWidgets('uses default priority tags', (tester) async {
      await tester.pumpWidget(MaterialAppGroupBySelector(
      ...
      expect(
        find.byWidgetPredicate(
          (Widget widget) =>
              ...
              (widget.label as Text).data == 'none' &&
    ...
    testWidgets('non default tag selected', (tester) async {
      ...
      expect(
        find.byWidgetPredicate(
          (Widget widget) =>
              widget is ChoiceChip &&
              (widget.label as Text).data == 'project' &&
              widget.selected == true,
        ),
        findsOneWidget,
      );
